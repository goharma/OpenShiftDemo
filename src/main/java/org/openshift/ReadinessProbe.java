...
public class ReadinessProbe {
     ...
     */
    public ReadinessProbe(Exec_ exec, Integer timeoutSeconds, Integer periodSeconds, Integer successThreshold, Integer failureThreshold) {
        super();
        this.exec = exec;
    ...
    @JsonProperty("exec")
    public Exec_ getExec() {
        return exec;
    }

    @JsonProperty("exec")
    public void setExec(Exec_ exec) {
        this.exec = exec;
    }
